...
const handler = createManifestHandler({
  async manifestFactory({ appBaseUrl }) {
    ...
    const manifest: AppManifest = {
      about:
        "MTG Import app for Saleor - bulk import Magic: The Gathering singles from Scryfall with full attribute support, job queue management, and set-level auditing.",
       ...
       * - MANAGE_PRODUCTS: Create products, variants, and channel listings
       */
